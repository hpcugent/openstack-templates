...
locals {
  ...
  http_string        = var.nginx_enabled ? "HTTP: http://${data.openstack_networking_floatingip_v2.public.address}:${openstack_networking_portforwarding_v2.http[0].external_port} (HTTPS :${openstack_networking_portforwarding_v2.http[0].external_port})" : ""
}
